...
public class DynamicSplitScreen : MonoBehaviour
{
    ...
    [SerializeField]
    private GameObject splitVerticalImage;

    [SerializeField]
    private GameObject splitHorizontalImage;

    [SerializeField]
    private GameObject playerListener1;

    [SerializeField]
    private GameObject playerListener2;

    [SerializeField]
    private float splitDistance = 10f;

    [SerializeField]
    private float listenerDistance = 2f;
